...
Note: The maximum number of triggers within a burst sequence is limited. If the maximum number is exceeded, images may be damaged or lost.
    ...
    */
    ...
    static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_All, "All" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_AnalogAll, "AnalogAll" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_DigitalAll, "DigitalAll" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Tap1, "Tap1" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Tap2, "Tap2" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Tap3, "Tap3" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Tap4, "Tap4" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Red, "Red" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Green, "Green" );        static_cast<GenApi::CEnumerationTRef<GainSelectorEnums> *> (&GainSelector )->SetEnumReference( GainSelector_Blue, "Blue" );        static_cast<GenApi::CIntegerRef*> (&GainRaw )->SetReference(_Ptr->GetNode("GainRaw"));
    ...
    static_cast<GenApi::CFloatRef*> (&ColorTransformationMatrixFactor )->SetReference(_Ptr->GetNode("ColorTransformationMatrixFactor"));
    ...
    static_cast<GenApi::CEnumerationTRef<TriggerDelaySourceEnums> *> (&TriggerDelaySource )->SetEnumReference( TriggerDelaySource_Time_us, "Time_us" );        static_cast<GenApi::CEnumerationTRef<TriggerDelaySourceEnums> *> (&TriggerDelaySource )->SetEnumReference( TriggerDelaySource_LineTrigger, "LineTrigger" );        static_cast<GenApi::CFloatRef*> (&TriggerDelayAbs )->SetReference(_Ptr->GetNode("TriggerDelayAbs"));
    static_cast<GenApi::CIntegerRef*> (&TriggerDelayLineTriggerCount )->SetReference(_Ptr->GetNode("TriggerDelayLineTriggerCount"));
    ...
    static_cast<GenApi::CIntegerRef*> (&ExposureTimeRaw )->SetReference(_Ptr->GetNode("ExposureTimeRaw"));
    ...
    static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Line1, "Line1" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Line2, "Line2" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Line3, "Line3" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Line4, "Line4" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Out1, "Out1" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Out2, "Out2" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Out3, "Out3" );        static_cast<GenApi::CEnumerationTRef<LineSelectorEnums> *> (&LineSelector )->SetEnumReference( LineSelector_Out4, "Out4" );        static_cast<GenApi::CEnumerationTRef<LineModeEnums> *> (&LineMode )->SetReference(_Ptr->GetNode("LineMode"));
    static_cast<GenApi::CEnumerationTRef<LineModeEnums> *> (&LineMode )->SetNumEnums(2);
    static_cast<GenApi::CEnumerationTRef<LineModeEnums> *> (&LineMode )->SetEnumReference( LineMode_Input, "Input" );        static_cast<GenApi::CEnumerationTRef<LineModeEnums> *> (&LineMode )->SetEnumReference( LineMode_Output, "Output" );        static_cast<GenApi::CEnumerationTRef<LineLogicEnums> *> (&LineLogic )->SetReference(_Ptr->GetNode("LineLogic"));
    ...
    static_cast<GenApi::CBooleanRef*> (&TimerSequenceEnable )->SetReference(_Ptr->GetNode("TimerSequenceEnable"));
    ...
    static_cast<GenApi::CIntegerRef*> (&GevVersionMajor )->SetReference(_Ptr->GetNode("GevVersionMajor"));
    ...
    static_cast<GenApi::CEnumerationTRef<GevInterfaceSelectorEnums> *> (&GevInterfaceSelector )->SetEnumReference( GevInterfaceSelector_NetworkInterface0, "NetworkInterface0" );        static_cast<GenApi::CIntegerRef*> (&GevMACAddress )->SetReference(_Ptr->GetNode("GevMACAddress"));
    ...
    static_cast<GenApi::CBooleanRef*> (&PixelFormatLegacy )->SetReference(_Ptr->GetNode("PixelFormatLegacy"));
    ...
    static_cast<GenApi::CEnumerationTRef<UserSetDefaultSelectorEnums> *> (&UserSetDefaultSelector )->SetReference(_Ptr->GetNode("UserSetDefaultSelector"));
    ...
    static_cast<GenApi::CEnumerationTRef<ColorOverexposureCompensationAOISelectorEnums> *> (&ColorOverexposureCompensationAOISelector )->SetReference(_Ptr->GetNode("ColorOverexposureCompensationAOISelector"));
    ...
    static_cast<GenApi::CEnumerationTRef<LastErrorEnums> *> (&LastError )->SetReference(_Ptr->GetNode("LastError"));
