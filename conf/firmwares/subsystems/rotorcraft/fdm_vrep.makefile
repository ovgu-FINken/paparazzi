...
nps.CFLAGS  += -I$(SRC_FIRMWARE) -I$(SRC_BOARD) -I$(PAPARAZZI_SRC)/sw/simulator -I$(PAPARAZZI_SRC)/sw/simulator/nps -I$(PAPARAZZI_HOME)/conf/simulator/nps -I$(VREP_PATH)/FinkenBehaviour/ -I/usr/include/eigen3
nps.LDFLAGS += $(shell sdl-config --libs)
nps.CXXFLAGS += -std=c++11 -I$(VREP_PATH)/FinkenBehaviour/ -I/usr/include/eigen3 -I$(EIGEN_INCLUDE$)
