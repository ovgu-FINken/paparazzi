...
namespace Basler_ImageFormatConverterParams
{
    ...
    */
    ...
    static_cast<GenApi::CEnumerationTRef<OutputBitAlignmentEnums> *> (&OutputBitAlignment )->SetEnumReference( OutputBitAlignment_LsbAligned, "LsbAligned" );        static_cast<GenApi::CEnumerationTRef<OutputBitAlignmentEnums> *> (&OutputBitAlignment )->SetEnumReference( OutputBitAlignment_MsbAligned, "MsbAligned" );        static_cast<GenApi::CIntegerRef*> (&OutputPaddingX )->SetReference(_Ptr->GetNode("OutputPaddingX"));
